...
def get_columns(filters):
	...
	columns.extend(
		[
			...
			{
				"label": _("Total Out Voucher Qty"),
				"fieldname": "total_out_voucher_qty",
				"fieldtype": "Float",
				"width": 100,
				"convertible": "qty",
			},
			...
			{"label": _("Origin Voucher Type"), "fieldname": "origin_voucher_type", "width": 140},
			{
				"label": _("Origin Voucher #"),
				"fieldname": "origin_voucher_no",
				"fieldtype": "Dynamic Link",
				"options": "origin_voucher_type",
				"width": 120,
			},
			{"label": _("Origin Posting Date"), "fieldname": "origin_posting_date", "fieldtype": "Date", "width": 140},
			{"label": _("Origin Posting Time"), "fieldname": "origin_posting_time", "fieldtype": "Time", "width": 140},
			{
				"label": _("Batch"),
				"fieldname": "batch_no",
				"fieldtype": "Link",
